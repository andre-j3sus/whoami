...
export const shows: Show[] = [
  ...
  {
    title: "Internet Insights with Cloudflare Radar: New TLD Metrics, Certificate Transparency, and Data Explorer",
  ...
  {
    title: "Introducing new Cloudflare Radar traffic insights",
